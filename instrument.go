...
type Instrument struct {
	...
	UnderlyingToPositionMultiplier float64   `json:"underlyingToPositionMultiplier,omitempty"`
	UnderlyingToSettleMultiplier   float64   `json:"underlyingToSettleMultiplier,omitempty"`
	QuoteToSettleMultiplier        float64   `json:"quoteToSettleMultiplier,omitempty"`
